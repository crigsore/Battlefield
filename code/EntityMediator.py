...
class EntityMediator:
    ...
    def __verify_collision_entity(ent1, ent2):
        ...
        if isinstance(ent1, Enemy) and isinstance(ent2, PlayerShoot):
            ...
            valid_interaction = True
        elif isinstance(ent1, EnemyTank) and isinstance(ent2, PlayerShoot):
            valid_interaction = True
        elif isinstance(ent1, PlayerShoot) and isinstance(ent2, EnemyTank):
            valid_interaction = True
        elif isinstance(ent1, Player) and isinstance(ent2, EnemyShoot):
            valid_interaction = True
        elif isinstance(ent1, EnemyShoot) and isinstance(ent2, Player):
            valid_interaction = True
        elif isinstance(ent1, Player) and isinstance(ent2, EnemyTShoot):
            valid_interaction = True
        elif isinstance(ent1, EnemyTShoot) and isinstance(ent2, Player):
            valid_interaction = True
